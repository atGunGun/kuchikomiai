    ...
    <div class="space-y-6">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900 flex items-center gap-2">
                <span class="text-2xl">📋</span> アンケート管理
            </h1>
            <p class="text-gray-500 mt-1">作成したアンケートの管理と、店頭でお客様に回答してもらうアンケートの切り替えができます。</p>
        </div>
        ...
        <div class="bg-white shadow-sm sm:rounded-2xl overflow-hidden border border-gray-100">
            ...
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 p-6 border-b border-gray-100 bg-gray-50/50">
                <h2 class="text-lg font-bold text-gray-700">登録済みアンケート一覧</h2>
                <a href="{{ route('surveys.create') }}" class="flex items-center justify-center text-white bg-green-600 hover:bg-green-700 font-bold rounded-xl text-sm px-6 py-2.5 transition-colors shadow-sm">
                    ＋ 新規作成
                </a>
            </div>
                        ...
                        <tr class="hover:bg-gray-50/80 transition-colors">
                            ...
                            <td class="px-6 py-5 text-center">
                                @if($company->selected_survey_id === $survey->id)
                                    <span class="inline-flex items-center gap-1 bg-green-100 text-green-800 text-xs font-bold px-3 py-1.5 rounded-full border border-green-200 shadow-sm">
                                        <span>✨</span> 使用中
                                    </span>
                                @else
