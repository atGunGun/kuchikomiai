...
<p class="text"><span class="green">*</span>入力必須項目</p>

<table class="contact_tb contact_tb1">
    <tbody>
        <tr>
            <th><label for="company">企業名<em>*</em></label></th>
            <td><input type="text" name="company" value="" id="company" class="validate[required]" placeholder="企業名をご入力ください"></td>
        </tr>

        <tr>
            <th><label for="name">お名前<em>*</em></label></th>
            <td><input type="text" name="name" value="" id="name" class="validate[required]" placeholder="お名前をご入力ください"></td>
        </tr>

        <tr>
            <th><label for="mail">メールアドレス<em>*</em></label></th>
            <td><input id="mail" type="text" name="mail" value="" class="validate[required,custom[email]]" placeholder="メールアドレスをご入力ください"></td>
        </tr>

        <tr>
            <th><label for="tel">お電話番号</label></th>
            <td><input id="tel" type="text" name="tel" value="" placeholder="お電話番号をご入力ください"></td>
        </tr>

        <tr>
            <th class="vert"><label for="msg">お問合せ内容<em>*</em></label></th>
            <td><textarea name="msg" id="msg" class="txtfiled validate[required]" placeholder="お問い合わせ内容をご入力ください"></textarea></td>
        </tr>

        <tr>
            <th class="vert"><label>個人情報保護方針</label></th>
            <td>
                <div class="pri_div">
                    <p class="text2">株式会社at Gun Gun（以下、「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下、「本サービス」といいます。）におけるプライバシー情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。</p>
                    <dl>
                        <dt>第1条（プライバシー情報）</dt>
                        <dd>1．プライバシー情報のうち「個人情報」とは、個人情報保護法にいう「個人情報」を指すものとし、生存する個人に関する情報であって、当該情報に含まれる氏名、生年月日、住所、電話番号、連絡先その他の記述等により特定の個人を識別できる情報を指します。2．プライバシー情報のうち「履歴情報および特性情報」とは、上記に定める「個人情報」以外のものをいい、ご利用いただいたサービスやご購入いただいた商品、ご覧になったページや広告の履歴、ユーザーが検索された検索キーワード、ご利用日時、ご利用の方法、ご利用環境、郵便番号や性別、職業、年齢、ユーザーのIPアドレス、クッキー情報、位置情報、端末の個体識別情報などを指します。</dd>
                        <dt>第２条（プライバシー情報の収集方法）</dt>
                        <dd>1．当社は、ユーザーが利用登録をする際に氏名、生年月日、住所、電話番号、メールアドレスなどの個人情報をお尋ねすることがあります。また、ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や、決済に関する情報を当社の提携先（情報提供元、広告主、広告配信先などを含みます。以下、｢提携先｣といいます。）などから収集することがあります。2．当社は、ユーザーについて、利用したサービスやソフトウエア、購入した商品、閲覧したページや広告の履歴、検索した検索キーワード、利用日時、利用方法、利用環境（携帯端末を通じてご利用の場合の当該端末の通信状態、利用に際しての各種設定情報なども含みます）、IPアドレス、クッキー情報、位置情報、端末の個体識別情報などの履歴情報および特性情報を、ユーザーが当社や提携先のサービスを利用しまたはページを閲覧する際に収集します。</dd>
                        ...
                        <dd>
                            ...
                            （4）ユーザーに代金を請求するために、購入された商品名や数量、利用されたサービスの種類、氏名、住所などに関する情報などを利用する目的<br>
                        ...
                        <dd>ユーザーは、当社の保有する自己の個人情報が誤った情報である場合には、当社が定める手続きにより、当社に対して個人情報の訂正または削除を請求することができます。 当社は、ユーザーから前項の請求を受けてその請求に応じる必要があると判断した場合には、遅滞なく、当該個人情報の訂正または削除を行い、これをユーザーに通知します。</dd>
                        <dt>第７条（個人情報の利用停止等）</dt>
                        <dd>当社は、本人から、個人情報が、利用目的の範囲を超えて取り扱われているという理由、または不正の手段により取得されたものであるという理由により、その利用の停止または消去（以下、「利用停止等」といいます。）を求められた場合には、遅滞なく必要な調査を行い、その結果に基づき、個人情報の利用停止等を行い、その旨本人に通知します。ただし、個人情報の利用停止等に多額の費用を有する場合その他利用停止等を行うことが困難な場合であって、本人の権利利益を保護するために必要なこれに代わるべき措置をとれる場合は、この代替策を講じます。</dd>
                        ...
                        <dd>
                            ...
                            住所（本社 ）：〒650-001 兵庫県神戸市中央区下山手通 2-13-11トアロードビル202<br>
                            社名：株式会社 at Gun Gun<br>
                            Eメールアドレス：info@at-gungun.com
                        </dd>
                    </dl>
                </div>
                <div class="privacy_area">
                    <label for="check"><input type="checkbox" name="check" id="check" class="validate[required]" value="個人情報の取り扱いについて、同意の上送信します。">個人情報の取り扱いについて、同意の上送信します。</label>
                </div>
            </td>
        </tr>
    </tbody>
</table>
<div class="send_btn btn3">
